...
function Home() {
  ...
  return (
    <div className='bubblebox'>
      ...
      <div className='sofaheader lilbubble'> Registration CLOSED for Survivor 47</div>
...
<div className='pl-3 w-full'><Link to='/tribes' className='bg-green-500 text-white p-4 w-full drop-shadow-lg hover:bg-blue-600' >View Tribes &rarr;&rarr;</Link>
      </div>
    </div>
  );
}
